...
int Object::getLuaRef() { return luaref; }
void Object::setLuaRef(int ref) { luaref = ref; }
int Object::getScriptRef() { return scriptref; }
void Object::setScriptRef(int ref) { scriptref = ref; }
